...
describe('filterData', () => {
  it('Debería ser una función filterData', () => {
    expect(typeof filterData).toBe('function');
  });

  it('Debería retornar un array de pokemones tipo Dragón', () => {
    expect(window.filterData(dataInput, 'Tipo', 'Dragon')).toEqual(aDragon);
  });
});
